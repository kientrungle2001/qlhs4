<div>
<dg.dataGrid id="dg" title="Quản lý nhân viên" table="teacher"
	...
	<layout.toolbar id="dg_toolbar">
		...
		<layout.toolbarItem action="$dg.detail(function(row){
			$dg_student.filters({assignId: row.id});
			$dg_ontest.filters({adviceId: row.id});
			$dg_advice.filters({adviceId: row.id});
			$dg_problem.filters({adviceId: row.id});

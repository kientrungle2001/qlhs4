<div>
<dg.dataGrid id="dg_billing" title="Danh sách hóa đơn" scriptable="true" 
		table="billing_order" width="800px" height="450px"
		defaultFilters='{"partyType": "teacher"}'
		>
	...
	<layout.toolbar id="dg_billing_toolbar">
		<hform id="dg_billing_search">
			<layout.toolbarItem action="$dg_billing.detail({url: '{url /order/billingdetail}', 'gridField': 'id', 'action': 'view', 'renderRegion': '#order-detail'});" icon="sum" />
			<layout.toolbarItem action="$dg_billing.del()" icon="remove" />
		</hform>
	</layout.toolbar>
</dg.dataGrid>

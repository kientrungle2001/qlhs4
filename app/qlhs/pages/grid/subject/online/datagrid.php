<dg.dataGrid id="dg" title="Quản lý phần mềm" table="subject" rownumbers="false" width="350px" height="450px" defaultFilters='{"online": 1}'>
	<dg.dataGridItem field="id" width="40">Id</dg.dataGridItem>
	<dg.dataGridItem field="name" width="160">Phần mềm</dg.dataGridItem>

<div>
	<div style="float: left; width: 350px">
		{include grid/subject/book/datagrid}
	</div>
	<div style="float: left; width: auto; margin-left:15px;">
		<div class="easyui-tabs" style="width: 850px;">
			<div title="Sách">
				{include grid/subject/book/classes}
			</div>
			<div title="Học sinh">
				{include grid/subject/book/student}
			</div>
			<div title="Đã mua">
			...
			{include grid/subject/book/advice}
			</div>
			<div title="Báo lỗi">
			<!-- TODO: danh sách báo lỗi -->
			{include grid/subject/book/problem}
			</div>
		</div>
	</div>

...
<ul id="menu">
	...
	<li><a href="{url /test/schedule}">Thi đầu vào</a>
		<ul>
			<li><a href="{url /test/schedule}">Kết quả</a></li>
			<li><a href="{url /student/ontest}">Danh sách học sinh</a></li>
		</ul>
	</li>
	<li><a href="{url /student/center}">Trung tâm</a>
		<ul>
			<li><a href="{url /student/center}">Danh sách học sinh</a></li>
			<li><a href="{url /demo/muster}">Điểm danh Theo lớp</a></li>
			<li><a href="{url /demo/orderstat}">Bảng học phí</a></li>
			<li><a href="{url /course/center}">Danh sách lớp học</a></li>
			...
			<li><a href="{url /subject/center}">Môn học</a></li>
			<li><a href="{url /student/schedule}">Điểm danh HS</a></li>
			<li><a href="{url /teacher/schedule}">Điểm danh GV</a></li>
	...
	<li><a href="{url /student/online}">Trực tuyến</a>
		<ul>
			<li><a href="{url /student/online}">Danh sách học sinh</a></li>
			...
			<li><a href="{url /subject/online}">Phần mềm</a></li>
			<li><a href="{url /course/online}">Khóa học</a></li>
		</ul>
	</li>
	<li>
	<a href="{url /student/book}">Sách</a>
	<ul>
		<li><a href="{url /student/book}">Học sinh</a></li>
		<li><a href="{url /course/book}">Sách</a></li>
	</ul>
	</li>
</ul>
<?php if (0) : ?>

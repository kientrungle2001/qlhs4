...
<div id="image-info">
	...
	Url: <input type="text" name="url" value="{item[url]}" onchange="imgObj.url = this.value; imgObj.serverView();"/><br />
</div>
...
var imgObj = {
	...
	serverView: function() {
		if(this.image){
			var result =  '<div id="banner" class="'+this.class+'"><a href="'+this.url+'"><img src="'+this.image.src+'" style="width:'+this.width+'; height: '+this.height+';" title="'+this.image_title+'" alt="'+this.alt+'" /></a></div>';

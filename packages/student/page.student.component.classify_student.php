...
<easyui.layout.panel collapsible="true" title="Xếp lớp" width="100%">
	...
	<form.selectbox label="Chọn lớp" id="cmbClass3" name="classId"
		sql="{class_center_enabled_sql}" />
	<span> sang lớp: </span>
	...
	<form.selectbox label="Chọn lớp" id="cmbClass4" name="classId"
		sql="{class_center_enabled_sql}" /><span>Ngày: </span>

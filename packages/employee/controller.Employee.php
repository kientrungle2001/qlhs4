...
class PzkEmployeeController extends PzkBaseController {
	public $grid = 'employee';
	public function billingAction() {
		$this->viewGrid('employee_billing');
	}

	public function create_billingAction() {
		$this->viewOperation('employee_create_bill');
	}
	...
	public function create_bill_postAction() {
		...
		header('Location: '.BASE_URL.'/index.php/employee/billing');
	}
	public function create_billing_multipleAction() {
		$this->viewOperation('employee_create_bill_multiple');
	}
